...
. Login to your Jenkins instance at https://jenkins-0.system.pivotalpoc.hosts.disney.pvt with the same username and password that you use for CloudFoundry.
